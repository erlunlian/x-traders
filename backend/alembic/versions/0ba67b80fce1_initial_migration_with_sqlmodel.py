...
Revision ID: 0ba67b80fce1
Revises: 
Create Date: 2025-08-27 22:41:21.715525
...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.Column('trader_id', sa.UUID(), nullable=False),
    sa.Column('llm_model', postgresql.ENUM('GPT_4O', 'GPT_4O_MINI', 'GPT_5', 'GPT_5_MINI', 'GPT_5_NANO', 'CLAUDE_35_SONNET', 'CLAUDE_35_HAIKU', 'GROK_BETA', 'GROK_2', name='llm_model'), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['trader_id'], ['trader_accounts.trader_id'], ),
    ...
    sa.Column('agent_id', sa.UUID(), nullable=False),
    sa.Column('trigger_type', postgresql.ENUM('TWEET', 'AUTONOMOUS', 'SCHEDULED', 'MARKET_EVENT', name='agent_decision_trigger'), nullable=False),
    sa.Column('trigger_tweet_id', sa.String(length=100), nullable=True),
    sa.Column('action', postgresql.ENUM('BUY', 'SELL', 'HOLD', 'RESEARCH', 'REST', 'CONTEMPLATE', 'CHECK_MARKET', 'ANALYZE_TWEETS', name='agent_action'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['trigger_tweet_id'], ['x_tweets.tweet_id'], ),
    ...
    sa.Column('agent_id', sa.UUID(), nullable=False),
    sa.Column('memory_type', postgresql.ENUM('WORKING', 'COMPRESSED', 'INSIGHTS', name='agent_memory_type'), nullable=False),
    ...
    sa.Column('thought_type', postgresql.ENUM('THINKING', 'ANALYZING', 'DECIDING', 'EXECUTING', 'REFLECTING', name='agent_thought_type'), nullable=False),
    sa.Column('content', sa.String(length=2000), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['agent_id'], ['ai_agents.agent_id'], ),
    sa.ForeignKeyConstraint(['decision_id'], ['agent_decisions.decision_id'], ),
    sa.PrimaryKeyConstraint('thought_id')
    )
    op.create_index(op.f('ix_agent_thoughts_created_at'), 'agent_thoughts', ['created_at'], unique=False)
